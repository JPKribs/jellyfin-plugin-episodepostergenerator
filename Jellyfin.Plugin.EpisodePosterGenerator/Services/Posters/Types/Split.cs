...
namespace Jellyfin.Plugin.EpisodePosterGenerator.Services.Posters
{
    public class SplitPosterGenerator : BasePosterGenerator
    {
        ...
        private float DrawSeparatorLine(PosterSettings config, SKCanvas canvas, float y, SKRect safeArea)
        {
        ...
        private void DrawEpisodeInfo(SKCanvas canvas, int seasonNumber, int episodeNumber, PosterSettings config, int canvasHeight, float bottomY, SKRect safeArea)
        {
