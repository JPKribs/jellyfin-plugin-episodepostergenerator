...
* **Long Titles**: what to do when a title does not fit. Ellipsis trims it. Abbreviate replaces it with word initials, skipping middle letters if the initials are still too wide. Drop Name hides it. Default Ellipsis.
